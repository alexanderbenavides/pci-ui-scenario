...
### Solution
1.- Modification in Grid.tsx component and index.html file.

2.- ag-grid provides an option to do that in defaultColDef prop. Date was ordered following yyyymmdd format to order chronologically easily.

3.- Date was ordered following yyyymmdd format using a reusable function.

4.- Hazardous column was modified using a reusable function and enums to be better maintainable.

5.- ag-grid provides an option to copy a cell, but no a group of cells or rows. So, I implemented an alterntive solution that
consist on selecting the rows and convert the data to csv  format (could be other format) to be ready to be copied.
